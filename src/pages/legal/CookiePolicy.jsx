  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="py-20 px-6 flex-1">
        <div className="max-w-4xl mx-auto bg-card border border-border rounded-3xl p-10 shadow-xl space-y-12">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            folosește cookie-uri și tehnologii similare în cadrul platformei TravelAI Deals.
          </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Cookie-urile sunt fișiere mici salvate pe dispozitivul tău care ne permit să oferim
              o experiență personalizată, sigură și optimizată.
            </p>
          </section>
          ...
          <section>
            <h2 className="flex items-center gap-2 text-xl font-semibold text-foreground mb-3">
              <Icon name="List" size={22} className="text-primary" />
              2. Tipuri de cookie-uri folosite
            </h2>

            <div className="space-y-6 mt-4 text-muted-foreground leading-relaxed">
              <div>
              ...
              <div>
                ...
                <p>
                  Folosite pentru tracking afiliere și măsurarea conversiilor venite prin link-urile
                  partenerilor (Booking, zboruri etc.). Necesită acordul tău.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Poți gestiona cookie-urile din setările browserului (ștergere, blocare totală sau
              parțială). În curând, vei putea gestiona cookie-urile direct din platforma TravelAI.
            </p>
          </section>
          ...
          <section>
            <h2 className="flex items-center gap-2 text-xl font-semibold text-foreground mb-3">
              <Icon name="RotateCcw" size={22} className="text-primary" />
